 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/Laboratory/msp430/TI_RTOS/Snake/configPkg/package/cfg/RTOS_pr430XS");
 ...
 */
xdc__META(__TARG__, "@(#)__TARG__ = iar.targets.msp430.MSP430X_small");
